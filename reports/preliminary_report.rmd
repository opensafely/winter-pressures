...
target_difference_file = "summer_winter_difference_histogram_redacted.png"
target_difference_metrics = list.files( path=here("output","metrics"), pattern=target_difference_file, full.names=TRUE, recursive=TRUE )
target_difference_appts = list.files( path=here("output","appointments"), pattern=target_difference_file, full.names=TRUE, recursive=TRUE )
all_seasonal_difference_histogram_filenames = c( target_difference_metrics, target_difference_appts )
